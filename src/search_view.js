...
ppixiv.search_view = class extends ppixiv.widget
{
    constructor({...options})
    {
        ...
        new ppixiv.pointer_listener({
            ...
            callback: (e) => {
                ...
                let { media_id } = ppixiv.app.get_illust_at_element(e.target);
                if(media_id == null)
                    return;
                ...
                ppixiv.app.show_media(media_id, { add_to_history: true });
            },
        });
    ...
    schedule_store_scroll_position()
    {
        ...
        {
            realClearTimeout(this.scroll_position_timer);
            this.scroll_position_timer = -1;
        }

        this.scroll_position_timer = realSetTimeout(() => {
